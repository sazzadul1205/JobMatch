  // resources/js/pages/Backend/ApplicantProfile/Create.jsx

  import { useState, useRef } from 'react';
  import { Head, router } from '@inertiajs/react';
  import { FaArrowLeft, FaSave, FaSpinner, FaUser, FaUpload, FaFilePdf, FaFileWord, FaFileAlt, FaCloudUploadAlt } from 'react-icons/fa';
  ...
  export default function Create() {
    ...
    const handleSubmit = (e) => {
      ...
      // FIXED: Use the correct route name with backend prefix
      router.post(route('backend.applicant.profile.store'), submitData, {
        onSuccess: () => {
      ...
      <AuthenticatedLayout>
        ...
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="mb-8">
            ...
            <p className="text-gray-600 mt-1">Fill in your details to create your applicant profile</p>
          </div>
              ...
              {preview.cv ? (
                <div className="flex items-center gap-3 bg-green-50 text-green-700 px-4 py-3 rounded-lg">
                  ...
                  <div className="flex-1">
                    <p className="text-sm font-medium">{preview.cv}</p>
